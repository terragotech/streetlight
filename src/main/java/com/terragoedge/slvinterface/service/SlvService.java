...
public class SlvService extends AbstractSlvService {
    ...
    private ResponseEntity<String> callSetDeviceValues(JPSWorkflowModel jpsWorkflowModel) {
        ...
        paramList.add("idOnController",jpsWorkflowModel.getIdOnController().trim());
        paramList.add("controllerStrId",jpsWorkflowModel.getControllerStrId());
        addStreetLightData("address", jpsWorkflowModel.getAddress1(), paramList,false);
        addStreetLightData("location.streetdescription", jpsWorkflowModel.getStreetdescription(), paramList,false);
        addStreetLightData("categoryStrId", jpsWorkflowModel.getCategoryStrId(), paramList,false);
        addStreetLightData("location.city", jpsWorkflowModel.getCity(), paramList,false);
        addStreetLightData("DimmingGroupName", "", paramList,false);
        addStreetLightData("provider.name", jpsWorkflowModel.getProvider_name(), paramList,false);
//        addStreetLightData("geoZone path", jpsWorkflowModel.getGeozonePath(), paramList);
        addStreetLightData("network.highvoltagethreshold", String.valueOf(jpsWorkflowModel.getHighvoltagethreshold()), paramList,false);
        addStreetLightData("idOnController", jpsWorkflowModel.getIdOnController().trim(), paramList,false);
        addStreetLightData("installStatus", jpsWorkflowModel.getInstallStatus(), paramList,false);
        addStreetLightData("lampType", jpsWorkflowModel.getLampType(), paramList,false);
        addStreetLightData("power", jpsWorkflowModel.getPower(), paramList,false);
//        addStreetLightData("lat", jpsWorkflowModel.getLat(), paramList);
        addStreetLightData("location.locationtype", jpsWorkflowModel.getLocationtype(), paramList,false);
//        addStreetLightData("lng", jpsWorkflowModel.getLng(), paramList);
        addStreetLightData("network.lowvoltagethreshold", String.valueOf(jpsWorkflowModel.getLowvoltagethreshold()), paramList,false);
        addStreetLightData("name", jpsWorkflowModel.getIdOnController().trim(), paramList,false);
        ...
        addStreetLightData("pole.shape", jpsWorkflowModel.getPole_shape(), paramList,false);
        addStreetLightData("pole.status", jpsWorkflowModel.getPole_status(), paramList,false);
        addStreetLightData("device.node.serialnumber", jpsWorkflowModel.getSerialnumber(), paramList,false);
        addStreetLightData("location.zipcode", jpsWorkflowModel.getLocation_zipcode(), paramList,false);
