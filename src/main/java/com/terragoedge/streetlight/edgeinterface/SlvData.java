...
public class SlvData extends CsvToBean {
    ...
    @CsvBindByName(column = "location_atlasphysicalpage")
    private String location_atlasphysicalpage;


    @CsvBindByName(column = "slvLatitude")
    private String slvLatitude;

    @CsvBindByName(column = "slvLongitude")
    private String slvLongitude;

    public String getSlvLatitude() {
        return slvLatitude;
    }

    public void setSlvLatitude(String slvLatitude) {
        this.slvLatitude = slvLatitude;
    }

    public String getSlvLongitude() {
        return slvLongitude;
    }

    public void setSlvLongitude(String slvLongitude) {
        this.slvLongitude = slvLongitude;
    }
